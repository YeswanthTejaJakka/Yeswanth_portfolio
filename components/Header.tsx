              ...
              {navItems.map((item) => (
                <li key={item.id} className="relative">
                  <button
                    ...
                    className="text-sm sm:text-base font-medium text-gray-600 hover:text-black dark:text-gray-300 dark:hover:text-white transition-colors duration-300 glow-enhanced"
                    data-interactive
                  >
                    {item.label}
                  </button>
