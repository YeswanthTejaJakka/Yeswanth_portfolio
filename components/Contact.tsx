    ...
    <section className="py-20 sm:py-28 text-center">
        ...
        >
            ...
            <div className="relative z-10">
                <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-gray-900 dark:text-white glow-strong">Let's Build Something Amazing</h2>
                <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-8 glow-enhanced">
                ...
                className="inline-block px-8 py-4 bg-accent-cyan text-primary rounded-full font-bold hover:bg-white transition-all duration-300 shadow-lg shadow-accent-cyan/20 glow-enhanced" data-interactive>
                    Say Hello
                </a>
            </div>
      </motion.div>
