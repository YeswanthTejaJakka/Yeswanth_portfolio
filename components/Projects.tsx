  ...
  return (
    ...
    >
        ...
        <div className="relative z-10 flex flex-col justify-end h-full">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white glow-enhanced">{project.title}</h3>
            <p className="text-gray-600 dark:text-gray-400 mt-2 h-24 overflow-hidden glow-enhanced">{project.description}</p>
            
            <div className="flex flex-wrap gap-2 mt-4">
                {project.tags.map(tag => (
                    <span key={tag} className="px-3 py-1 text-xs bg-blue-500/10 text-blue-600 dark:bg-accent-cyan/10 dark:text-accent-cyan rounded-full glow-enhanced">
                        {tag}
                    </span>
                ))}
            </div>
  ...
  return (
    <section className="py-20 sm:py-28">
      <div className="text-center mb-12">
        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white glow-strong">Featured Projects</h2>
        <p className="text-gray-600 dark:text-gray-400 mt-2 glow-enhanced">A selection of my recent work.</p>
      </div>
