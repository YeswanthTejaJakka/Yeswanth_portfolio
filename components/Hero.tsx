...
const InteractiveProfileImage: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <motion.img 
                src="https://i.postimg.cc/j5hWCQ3s/Whats-App-Image-2026-03-19-at-22-14-07.jpg" 
                alt="Yeswanth Teja" 
  ...
  return (
    <section className="min-h-screen flex flex-col md:flex-row items-center justify-center gap-12 text-center md:text-left pt-24 pb-12">
      <div className="md:w-1/2 space-y-4">
        <motion.h1 
            className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight text-gray-800 dark:text-white glow-strong"
        ...
        <motion.p 
            className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-xl mx-auto md:mx-0 glow-enhanced"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
            <a 
                ...
                className="inline-flex items-center gap-2 px-8 py-3 bg-accent-cyan text-primary rounded-full font-bold hover:bg-white transition-all duration-300 shadow-lg shadow-accent-cyan/20 glow-enhanced" 
                data-interactive
            >
            ...
            <button 
                ...
                className="px-8 py-3 bg-transparent text-accent-cyan border-2 border-accent-cyan rounded-full font-semibold hover:bg-accent-cyan/20 transition-all duration-300 glow-enhanced" 
                data-interactive
            >
                Get In Touch
            </button>
