    ...
    <section className="py-20 sm:py-28">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white glow-strong">My Tech Stack</h2>
          <p className="text-gray-600 dark:text-gray-400 mt-2 glow-enhanced">Languages, tools, and platforms I love to work with.</p>
        </div>
        
        <div className="space-y-12">
          <div>
            <h3 className="text-xl sm:text-2xl font-semibold text-center mb-6 text-gray-800 dark:text-gray-300 glow-enhanced">Programming Languages</h3>
            <div className="relative">
              <LogoLoop logos={languages} speed={50} logoHeight={40} />
            </div>
          </div>
          <div>
            <h3 className="text-xl sm:text-2xl font-semibold text-center mb-6 text-gray-800 dark:text-gray-300 glow-enhanced">Tools & Platforms</h3>
            <div className="relative">
